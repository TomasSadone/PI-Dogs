...
const { DB_USER, DB_PASSWORD, DB_HOST, DB_EXTERNAL } = process.env;
...
// (async () => {
//   await Dog.sync({ force: false });
//   await Temperament.sync({ force: false });

//   // Insertar el primer registro con el valor deseado para la clave primaria
...
//   const temperament = await Temperament.create({ name: 'quiet' });
